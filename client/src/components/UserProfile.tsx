      ...
      <div className="max-w-2xl w-full bg-white bg-opacity-80 backdrop-blur-lg p-8 rounded-lg shadow-xl flex flex-col">
        <main className="space-y-6">
          {userProfile.map(user => (
            <Card key={user.userId} className="p-4 flex flex-col text-black border border-gray-200 rounded-lg shadow hover:shadow-md transition-shadow">
              ...
              <div className="flex items-center mb-2">
                ...
                <div className="text-lg">
                  <p>User ID: <span className="font-bold">{user.userId}</span></p>
